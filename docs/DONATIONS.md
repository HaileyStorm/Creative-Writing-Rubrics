# Supporting Creative-Writing-Rubrics

Creative-Writing-Rubrics is free to use. Donations are optional, have no effect on access or support, and help fund maintenance and model/GPU testing.
...
Vast.ai credit can be transferred to `HaileyCollet@gmail.com` to support GPU testing.
...
Use your existing Vast.ai sign-in or CLI authentication. This project does not ask for, receive, or store a Vast.ai API key.
...
The current public maintainer page is [Buy Me a Coffee](https://buymeacoffee.com/threadspan). It supports one-time contributions and memberships through Buy Me a Coffee's hosted payment flow; this repository never receives payout credentials or card details.
