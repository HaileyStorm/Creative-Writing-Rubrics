...
- [V8 multisample continuation](../evaluation-results/hbq-multisample-repeatability-v1-remainder-capacity-reset-successor-v8/): all 330 cells are collected (11 stories × six methods × five repetitions); a public repeatability result awaits integrity-checked analysis. Each story uses one HBQ version across its repetitions, but the full panel includes both 1.0.0 and 1.2.1.
