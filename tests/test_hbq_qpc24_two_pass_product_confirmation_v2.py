...
def test_public_v2_is_provider_free_full_fidelity_and_exactly_bound():
    result=_public().validate()
    assert result["provider_calls"] == 0 and result["planned_voting_calls"] == 60
    assert result["verdict_positions"] == 1326 and result["maximum_unique_contacts"] == 60
