...
@pytest.mark.parametrize(
    ("evidence", "valid"),
    [
        ({"kind": "exact_quote", "reference": "artifact", "exact_quote": "A short test scene.", "summary": None}, True),
        ({"kind": "summary", "reference": "artifact", "exact_quote": None, "summary": "The scene is short."}, True),
        ({"kind": "summary", "reference": "artifact", "exact_quote": "A short test scene.", "summary": None}, False),
        ({"kind": "exact_quote", "reference": "artifact", "exact_quote": None, "summary": "The scene is short."}, False),
        ({"kind": "summary", "reference": "artifact", "exact_quote": None, "summary": "   "}, False),
    ],
)
def test_response_schema_matches_native_evidence_discriminator(
    evidence: dict[str, object], valid: bool
) -> None:
    schema = json.loads((book_root() / "schema" / "hbq_judge_response.schema.json").read_text(encoding="utf-8"))
    payload = {
        "verdicts": [{
            "question_id": QUESTION_ID,
            "verdict": "YES",
