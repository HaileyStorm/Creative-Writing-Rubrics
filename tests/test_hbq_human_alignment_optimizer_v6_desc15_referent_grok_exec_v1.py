...
PACKAGE = ROOT / "evaluation-results" / "hbq-human-alignment-optimizer-v6-desc15-referent-grok-exec-v1"
FREEZE = Path(r"C:\Users\Haile\Documents\cwr-hanna-desc15-referent-freeze-38ac0b7-20260901a")
ACK = "2fb371ff82b37fe22d238a223fc030ad7a7bb9a10b672719da081470d25dbe78"


def load():
    spec = importlib.util.spec_from_file_location("_desc15_referent_grok_exec_test", PACKAGE / "executor.py")
...
def route_provider(counter: dict[str, int] | None = None):
    route = {"name": "grok-build-grok-4.6", "model": "grok-4.6", "reported_model": "grok-4.6-build", "adapter": "grok_exec", "provider": "xai_grok_build", "destination": "xai_grok_build_subscription", "zero_charge": True, "armed": True, "health": "healthy", "reasoning_effort": "high", "grok_command": ["fixture"], "allowed_payload_classes": ["public_repo", "public_synthetic"], "timeout_seconds": 1.0}
    lock = threading.Lock()
    def provider(_queue: Path):
        ...
        return route, {"kind": "fixture-current-zero-charge-proof"}
    return provider
