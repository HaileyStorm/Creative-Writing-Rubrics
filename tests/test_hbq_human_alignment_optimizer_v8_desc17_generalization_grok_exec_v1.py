...
PACKAGE = ROOT / "evaluation-results" / "hbq-human-alignment-optimizer-v8-desc17-generalization-grok-exec-v1"
FREEZE = Path(r"C:\Users\Haile\Documents\cwr-hanna-desc17-generalization-freeze-commit-pending-20260901a")
ACK = "2fb371ff82b37fe22d238a223fc030ad7a7bb9a10b672719da081470d25dbe78"


def load():
    spec = importlib.util.spec_from_file_location("_desc17_generalization_grok_exec_test", PACKAGE / "executor.py")
