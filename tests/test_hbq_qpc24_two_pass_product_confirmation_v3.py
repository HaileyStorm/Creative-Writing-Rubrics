...
def test_public_v3_geometry_is_provider_free_full_fidelity():
 r=public().validate();assert r['provider_calls']==0 and r['inherited_complete_voting_calls']==30 and r['planned_new_voting_calls']==30 and r['planned_total_voting_calls']==60 and r['verdict_positions']==1326
