"""Explicit command boundary for the contextual-justification treatment executor."""
...
def main() -> None:
    ...
    if args.dry_run:
        ...
        result = execute(args.private_root, allow_remote=True, acknowledged_zero_incremental_charge=True)
