...
STUDY_ID = "hbq-human-alignment-optimizer-v5-f20-nextwave-sol6-validation-exec-v2-current-route"
...
PREDECESSOR_COMMIT = "133d0dfbb8af82a88392c0cf32b4b52f01b0943a"
PREDECESSOR_FILES = {
    "evaluation-results/hbq-human-alignment-optimizer-v5-f20-nextwave-sol6-validation-exec-v1/README.md": "c4742676bb19bcb39f812a3afe96a4e74b00d488e82710d25ed28d6c33f53c1f",
    "evaluation-results/hbq-human-alignment-optimizer-v5-f20-nextwave-sol6-validation-exec-v1/executor.py": "99b177161289f1e4b5b43dafbd3464e6e1de73e400804f4b4673d98a6ae6c1b9",
    "evaluation-results/hbq-human-alignment-optimizer-v5-f20-nextwave-sol6-validation-exec-v1/study-contract.json": "6791bc2f40e7943bc511cb11def5781d30bb3686528e83e09c504f8cfbb84d79",
    "tests/test_hbq_human_alignment_optimizer_v5_f20_nextwave_sol6_validation_exec_v1.py": "e8a464dda2bd4313ee9fdac7a4692533d2ef47828a191b8e0db0155a4c9f6d93",
}
...
def _verify_predecessor() -> None:
    ...
    for relative, digest in PREDECESSOR_FILES.items():
        ...
        if sha256(raw) != digest or blob.returncode != 0 or blob.stdout != raw:
            raise ValueError("pinned V1 predecessor drifted")
